...
def create(authorization_code, redirect_uri, code_verifier, client_id, authorization):
    uri = Ibanity.client.api_schema_ponto["token"] \
    body = {
...
def create(refresh_token, authorization, client_id):
    uri = Ibanity.client.api_schema_ponto["token"] \
    body = {
